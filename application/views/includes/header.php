    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-mini"><b>Big686</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Big686 </b></span>
        </a>
            ...
            <li>
             ...
             <li>
              <a href="<?php echo base_url(); ?>config" >
                ...
                <span>Cập nhật hũ tài xỉu</span>
              </a>
            </li>  
            <li>
              <a href="<?php echo base_url(); ?>sessionSicbo" >
                <i class="fa fa-money-o"></i>
                <span>Check phiên tài xỉu</span>
              </a>
            </li>  
            <li>
