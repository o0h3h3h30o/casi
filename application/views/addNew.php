                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nickname" value="<?php echo set_value('nickname'); ?>" name="nickname" maxlength="128">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="fname">Tên đại lý (nếu là đại lý)</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('store_title'); ?>" id="store_title" name="store_title" maxlength="128">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="phone" value="<?php echo set_value('phone'); ?>" name="phone" maxlength="128">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
